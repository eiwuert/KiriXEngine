...
@section('main')
  ...
  @include('back.partials.entete', ['title' => trans('back/blog.dashboard') . link_to_route('admin.blog.create', trans('back/blog.add'), [], ['class' => 'btn btn-info pull-right page-header-add']), 'icone' => 'pencil', 'fil' => ""])
